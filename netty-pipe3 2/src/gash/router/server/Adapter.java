...
/**
 * Adapter Server : Accepts request from external cluster and handles it inside own cluster
...
public class Adapter {
     ...
     * @param cfg
     */
    public Adapter(File cfg) {
        init(cfg);
    }

    public Adapter(RoutingConf conf) {
        this.conf = conf;
    }
    ...
    private static class StartWorkCommunication implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                boolean compressComm = false;
                b.childHandler(new AdapterInit());

                // Start the server.
                logger.info("Starting Adapter (" + state.getConf().getNodeId() + "), listening on port = "
...
//					emon.shutdown();
    ...
    public static class JsonUtil {
        ...
        public static JsonUtil getInstance() {
            if (instance == null)
                throw new RuntimeException("Adapter has not been initialized");
